...
function Portfolio_test() {
  ...
  const [showAsFirst, setShowAsFirst] = useState(false);
  const [showAsSecond, setShowAsSecond] = useState(false);
  ...
  const showAllItems = () => {
    ...
    setShowAsFirst(false);
    setShowAsSecond(false);
  }
  ...
  const showFourthCategory = () => {
    ...
    if (showAsSecond == false){
      setShowAsSecond(true);
    }
  }
        ...
        <Container>
          ...
          <div className='portfolio_list fadeInUp'>
            <ul className='gallery_zoom grid' style={{position: 'relative', height: 957.126}}>
              ...
              <li className={'popup grid_item popUp' + (showFourthItem ? " show":" hide") } style={{
                                                                                            left: 0, 
              ...
              <li className={'popup grid_item' + (showFifthItem ? " show":" hide")} style={{
                                                                                      left: ( isMobile ? 0 : 35+'%'), 
